...
## as a 3x3 block: rows are idle / on-screen / all, columns are army / builder /
## production. The right two columns stay blank.
static var _SELECT_BINDINGS: Array = [
	...
	ControlBinding.new(RTSController.CMD_SELECT_ARMY_ON_SCREEN, "Army Scr", Vector2i(0, 1), ControlBinding.ControlContext.SELECT,
	...
	ControlBinding.new(RTSController.CMD_SELECT_ARMY_ALL, "All Army", Vector2i(0, 2), ControlBinding.ControlContext.SELECT,
		"Select all army units",
		"Select every armed unit you own, anywhere on the map — on screen or not."),
	ControlBinding.new(RTSController.CMD_SELECT_IDLE_BUILDER, "Idle Bldr", Vector2i(1, 0), ControlBinding.ControlContext.SELECT,
	...
	ControlBinding.new(RTSController.CMD_SELECT_BUILDERS_ALL, "All Bldr", Vector2i(1, 2), ControlBinding.ControlContext.SELECT,
		"Select all builders",
		"Select every builder you own, anywhere on the map — on screen or not."),
	ControlBinding.new(RTSController.CMD_SELECT_IDLE_PRODUCTION, "Idle Prod", Vector2i(2, 0), ControlBinding.ControlContext.SELECT,
	...
	ControlBinding.new(RTSController.CMD_SELECT_PRODUCTION_ON_SCREEN, "Prod Scr", Vector2i(2, 1), ControlBinding.ControlContext.SELECT,
