...
| Lesson                           | Situation                                                  |
| -------------------------------- | ---------------------------------------------------------- |
| Basic combat                     | fight sentry vs warlord<br>                                |
| Using abilities                  | Technician drop                                            |
| Building, Training               | Construct outpost, collect resources, train units          |
| counters, abilities              | tech toxins vs anti-inf-inf                                |
| Upgrades, garrison, flight       | rainbird (with upgrade) to fly through a safer route       |
